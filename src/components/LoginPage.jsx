            ...
            <form onSubmit={(e)=>{
                ...
                <div className="flex justify-around">
                {
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        user.UserName.length>4 && user.Password.length>4 ? user.UserName===JSON.parse(RetreiveData())?.name  && user.Password===decrypt(JSON.parse(RetreiveData())?.password) ? setPassCorrect(true) || navigate("/") || setAuth(user.UserName) :setPassCorrect(false):"";
                    }}>Login</button>
