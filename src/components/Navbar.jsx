    ...
    return (
      ...
      <nav className=" bg-white h-20 flex justify-evenly items-center drop-shadow-lg">
        ...
        <ul className="flex gap-10">
            ...
            <ul className=" invisible bg-white absolute top-20 p-1 rounded-b-lg peer-focus:visible active:visible ease-linear">
        ...
        <ul className="flex gap-10 justify-center items-center">
            ...
            <li><a className="flex justify-center items-center gap-3 hover:text-blue-500 hover:scale-110 duration-300" href="#"><img className="w-6 h-6" src={cart_icon} alt="cart" /> <p>Cart</p></a></li>
        </ul>
      </nav>
      </> 
    )
